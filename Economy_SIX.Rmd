...
# Zweite Lockdown-Lockerung
In der ersten Woche der zweiten Lockerungsphase gab es an vielen Tagen neue Jahreshöchstände. Ausnahmen sind der Montag und der Freitag, wo es während der Übergangsphase zum Lockdown noch höhere stationäre Debitkartenumsätze gab, sowie der Sonntag. Die nach wie vor tieferen Sonntagsumsätze dürften dem Umstand geschuldet sein, dass viele Freizeitangebot noch geschlossen sind. Wie sich die Zahlen in den nächsten Tagen entwickeln bleibt also spannend. Die interaktive Grafik wird deshalb fortlaufend aktualisiert.
